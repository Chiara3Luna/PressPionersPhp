<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-3 zoom">
            ...
            <div class="card">
                <div class="card-body">
                    <img src="https://picsum.photos/370/170" alt="Immagine di repertorio">
                    <hr>
        ...
        <div class="col-12 col-md-3 zoom">
            ...
            <div class="card">
                <div class="card-body">
                    <img src="https://picsum.photos/370/171" alt="Immagine di repertorio">
                    <hr>
        ...
        <div class="col-12 col-md-3 zoom">
            ...
            <div class="card">
                <div class="card-body">
                    <img src="https://picsum.photos/370/172" alt="Immagine di repertorio">
                    <hr>
